...
public class PicassoUtils {
    ...
    //Picasso.with(context).load(contactUri).placeholder(R.drawable.contact_picture_placeholder).tag(context).into(holder.ht_bh);
    /**
     * 加载图片通过地址
     * @param context
     * @param path
    ...
    public void LoadImage(Context context,String path,ImageView imageView,int placeholderimage,int errorimage,String bitmapShowType,float roundRadius){
        if(MyUtils.isEmpty(path)){
            LogUtils.e("图片加载异常：图片地址为空");
            Picasso.with(context).load(R.drawable.image_placeholder).placeholder(R.drawable.image_placeholder).error(R.drawable.image_placeholder).into(imageView);
        }else {
    ...
    public void LoadImage(Context context,String path,ImageView imageView){
        if(MyUtils.isEmpty(path)){
            ...
            Picasso.with(context).load(path).placeholder(R.drawable.image_placeholder).error(R.drawable.image_placeholder).into(imageView);
        }
    }
    /**
     * 加载图片本地 通过id
    ...
    public void LoadImage(Context context,int localimage,ImageView imageView,String bitmapShowType,float roundRadius){
        if(bitmapShowType.equals(PICASSO_BITMAP_SHOW_CIRCLE_TYPE)){
            Picasso.with(context).load(localimage).placeholder(R.drawable.image_replace).error(R.drawable.image_placeholder).transform(new CircleTransform()).into(imageView);
        }else if(bitmapShowType.equals(PICASSO_BITMAP_SHOW_ROUND_TYPE)){
