...
public class LogUtils {
    ...
    public static void v(String content) {
        ...
        if (customLogger != null) {
            ...
            printNormalv(tag, content);
        }
    }

    public static void printNormalv(String tag,String msg){
    ...
    public static void printNormalw(String tag,String msg){
        int segmentSize = 3 * 1024;
        long length = msg.length();
        if (length <= segmentSize ) {// 长度小于等于限制直接打印
            Log.w(tag, msg);
    ...
    public static void printNormald(String tag,String msg){
        int segmentSize = 3 * 1024;
        long length = msg.length();
        if (length <= segmentSize ) {// 长度小于等于限制直接打印
            Log.d(tag, msg);
    ...
    public static void printNormali(String tag,String msg){
        int segmentSize = 3 * 1024;
        long length = msg.length();
        if (length <= segmentSize ) {// 长度小于等于限制直接打印
            Log.i(tag, msg);
    ...
    public static void printNormale(String tag,String msg){
        int segmentSize = 3 * 1024;
        long length = msg.length();
        if (length <= segmentSize ) {// 长度小于等于限制直接打印
            Log.e(tag, msg);
