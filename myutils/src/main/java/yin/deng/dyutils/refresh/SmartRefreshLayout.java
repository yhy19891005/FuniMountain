package yin.deng.dyutils.refresh;
...
import yin.deng.dyutils.refresh.api.RefreshContent;
...
import yin.deng.dyutils.refresh.api.ScrollBoundaryDecider;
import yin.deng.dyutils.refresh.constant.DimensionStatus;
import yin.deng.dyutils.refresh.constant.RefreshState;
import yin.deng.dyutils.refresh.constant.SpinnerStyle;
import yin.deng.dyutils.refresh.footer.BallPulseFooter;
import yin.deng.dyutils.refresh.header.BezierRadarHeader;
import yin.deng.dyutils.refresh.header.FalsifyHeader;
import yin.deng.dyutils.refresh.impl.RefreshContentWrapper;
import yin.deng.dyutils.refresh.impl.RefreshFooterWrapper;
import yin.deng.dyutils.refresh.impl.RefreshHeaderWrapper;
import yin.deng.dyutils.refresh.listener.OnLoadmoreListener;
import yin.deng.dyutils.refresh.listener.OnMultiPurposeListener;
import yin.deng.dyutils.refresh.listener.OnRefreshListener;
import yin.deng.dyutils.refresh.listener.OnRefreshLoadmoreListener;
import yin.deng.dyutils.refresh.util.DelayedRunable;
import yin.deng.dyutils.refresh.util.DensityUtil;
import yin.deng.dyutils.refresh.util.ViscousFluidInterpolator;
...
public class SmartRefreshLayout extends ViewGroup implements RefreshLayout, NestedScrollingParent, NestedScrollingChild {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        mHeaderHeight = ta.getDimensionPixelOffset(R.styleable.SmartRefreshLayout_srlHeaderHeight, density.dip2px(60));
...
//        mRefreshContent = null;
    ...
    protected void setStateRefresing() {
        ...
        if (mRefreshListener != null) {
            if(mRefreshFooter!=null) {
                mRefreshFooter.setLoadmoreFinished(false);
            }
