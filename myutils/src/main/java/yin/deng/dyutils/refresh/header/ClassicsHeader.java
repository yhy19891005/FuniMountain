package yin.deng.dyutils.refresh.header;
...
import yin.deng.dyutils.refresh.internal.ProgressDrawable;
import yin.deng.dyutils.refresh.internal.pathview.PathsDrawable;
       ...
       // layout.addView(mLastUpdateText, lpUpdateText);
        ...
        if (getPaddingTop() == 0) {
            if (getPaddingBottom() == 0) {
                setPadding(getPaddingLeft(), mPaddingTop = density.dip2px(20), getPaddingRight(), mPaddingBottom = density.dip2px(0));
            } else {
                setPadding(getPaddingLeft(), mPaddingTop = density.dip2px(20), getPaddingRight(), mPaddingBottom = getPaddingBottom());
            }
        } else {
            if (getPaddingBottom() == 0) {
                setPadding(getPaddingLeft(), mPaddingTop = getPaddingTop(), getPaddingRight(), mPaddingBottom = density.dip2px(0));
            } else {
