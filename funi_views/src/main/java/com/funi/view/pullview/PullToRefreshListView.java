...
import com.funi.view.pullview.internal.EmptyViewMethodAccessor;
import com.funi.view.pullview.internal.LoadingLayout;
...
public class PullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> {
    ...
    protected final ListView createRefreshableView(Context context, AttributeSet attrs) {
        ...
        if (mode == MODE_PULL_DOWN_TO_REFRESH || mode == MODE_BOTH) {
            ...
            frame.addView(headerLoadingView, FrameLayout.LayoutParams.MATCH_PARENT, FrameLayout.LayoutParams.WRAP_CONTENT);
        ...
        if (mode == MODE_PULL_UP_TO_REFRESH || mode == MODE_BOTH) {
            ...
            frame.addView(footerLoadingView, FrameLayout.LayoutParams.MATCH_PARENT, FrameLayout.LayoutParams.WRAP_CONTENT);
    ...
    public void setSubText(String sub){
        headerLoadingView.setSubText(sub);
    }
...
//                setSubText(format.format(System.currentTimeMillis()));
                break;
        }
